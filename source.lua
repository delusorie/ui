if getgenv().diarian and getgenv().diarian.Unload then
...
local Library = { } do
    ...
    Library.AssetsFolder = "diarian/Assets"
    ...
    Library.Window = function(Self, Params)
        ...
        Items.SubBar = MakeFrame({
            ...
            Pos = UDim2.fromOffset(W - SubW - 150, 0),
...
Items.ProfileCard = MakeFrame({
    ...
    Z      = 4
        ...
        AttachPopup({
            ...
            From = 10,
            To = 0,
            Retreat = function(Current)
                return UDim2.fromOffset(Current.X.Offset, Current.Y.Offset + 10)
            end,
            HoldOpen = function()
